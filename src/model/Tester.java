...
//        for (String rKey: mapOfReservationKeys.keySet()){
//        for (Reservation rKey: mapOfReservationKeys.keySet()){
        for (ReservationKey rKey: mapOfReservationKeys.keySet()){
            System.out.println(rKey);
//            System.out.println(rKey.getRoom().getRoomNumber());
        }

        System.out.println("Reservation Values");
        for (ReservationKey rKValue : mapOfReservationKeys.values()){
            System.out.println(rKValue);
            System.out.println(rKValue.getRoomNumber());
        }
